...
const articleSeeds: Array<{
  ...
  },
  {
    ...
    relatedQuizzes: ["guardian-crystal"],
    content: [
      "粉晶、紫水晶與黑曜石，是很多人剛接觸水晶時最常遇見的三種象徵。它們不需要被理解成神奇道具，也不適合被說成能保證改變命運。更溫和、也更實用的方式，是把它們當成日常提醒：提醒你靠近某種狀態，也看見自己目前容易失衡的地方。",
      "### 粉晶：關係裡的溫柔，不等於討好",
      "粉晶常被連結到愛、關係、柔軟與自我接納。它提醒的不是「我要趕快被愛」，而是先看見自己在關係裡是否太急著證明價值、太快把對方的反應解讀成自己的不足。",
      "如果你最近在人際或感情中很敏感，粉晶可以作為一個溫柔的提示：先把注意力放回自己的感受。你可以問自己，我現在真正需要的是確認、陪伴，還是更清楚的界線？當你能分辨需求，就比較不容易把焦慮交給別人決定。",
      "### 紫水晶：把雜訊放低，讓直覺變清楚",
      "紫水晶常被視為直覺、沉澱與清明的象徵。它適合用在資訊太多、想法太亂、一直反覆確認答案的時候。紫水晶的提醒不是叫你逃離現實，而是先讓心安靜一點，再回來判斷事情。",
      "當你很想立刻得到答案，可以先把問題縮小：我現在知道哪些事實？哪些只是猜測？哪些是我害怕發生的劇本？這個整理過程，會讓直覺不再被焦慮蓋過。真正的直覺通常很安靜，不會用恐嚇或催促的語氣逼你行動。",
      "### 黑曜石：保護自己，也看見陰影",
      "黑曜石常和保護、界線、清理混亂有關。它提醒你，不是所有消耗都要用忍耐處理。有些關係、環境或習慣，如果長期讓你失去穩定感，就需要被誠實看見。",
      "但黑曜石的象徵也不只是把外界都視為危險。它同時提醒你觀察自己的陰影：我是不是一直在承擔不屬於自己的責任？我是不是把害怕失去，誤認成必須留下？當界線變清楚，保護就不再只是防衛，而是讓你有空間回到自己。",
      "### 怎麼在日常中使用這三種提醒",
      "你不一定需要真的擁有水晶，也可以把它們當成三種提問方式。粉晶問：我有沒有善待自己的感受？紫水晶問：我能不能先讓雜訊安靜？黑曜石問：我需要在哪裡建立界線？",
      "如果你想做一個簡單練習，可以選今天最有感的一種象徵，寫下一句提醒。例如：我可以溫柔但不討好、我先整理事實再做決定、我不必承擔所有人的情緒。這些提醒不會替你決定人生，但能幫你把注意力從混亂拉回當下。",
      "本文以象徵與自我探索角度理解水晶，不宣稱任何醫療、心理治療或保證式效果。若你正在面對重大身心狀況、法律、投資或人生決策，仍建議尋求合格專業人士協助。"
    ]
  },
  {
...
export const articles: Article[] = articleSeeds.filter((article) => article.category !== "tarot-meanings").map((article, index) => {
  ...
  return {
    ...
    content: article.content ?? buildArticleContent(article.title, article.excerpt, categoryLabel, article.tags)
  };
});
